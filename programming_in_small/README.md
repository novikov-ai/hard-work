...
Подберите три примера функций/методов, где выходные данные достаточно сложны (или меняется состояние нескольких полей объекта), и перепишите их в ко-рекурсивном формате: алгоритм следует за структурой выходных данных. В коде добавьте подробные комментарии, как именно вы придерживались данной схемы.
